...
export const serie2 = new series(1, "Stranger Things", "Netflix", 4)
export const serie3 = new series(1, "Gossip Girl", "HBO", 10)
export const serie4 = new series(1, "Gilmore Girls", "Netflix", 10)
export const serie5 = new series(1, "Ginny and Georgia", "Netflix", 10)
...
function mostrarDatosSerie(serie1: series, serie2: series, serie3:series, serie4:series, serie5:series):void{
